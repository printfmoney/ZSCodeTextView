...
#import "ZSTFCursorView.h"

@interface ZSTFCursorView ()
...
@property (nonatomic, strong) NSMutableArray<ZSCursorLabel *> *labels;

@property (nonatomic, strong) NSMutableArray<UIView *> *lines;

@property (nonatomic, weak) ZSCursorLabel *currentLabel;

@end

@implementation ZSTFCursorView
...
- (void)configTextField {
    ...
    for (NSInteger i = 0; i < self.itemCount; i++) {
        ZSCursorLabel *label = [ZSCursorLabel new];
...
- (void)cursor {
    ...
    ZSCursorLabel *label = [self.labels objectAtIndex:index];
